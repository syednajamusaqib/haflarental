document.addEventListener("DOMContentLoaded", function () {
  ...
  const images = [
    "service12_images/1.jpg", "service12_images/2.jpg", 
    "service12_images/3.jpg", "service12_images/4.jpg", "service12_images/5.jpg", 
    "service12_images/6.jpg",
    "service12_images/7.jpg", "service12_images/8.jpg", 
    "service12_images/9.jpg", "service12_images/10.jpg", "service12_images/11.jpg", 
    "service12_images/12.jpg",
    "service12_images/13.jpg",
    "service12_images/14.jpg",
  ];
  ...
  function loadImages(count) {
    for (let i = currentImageCount; i < currentImageCount + count && i < images.length; i++) {
      ...
      imgElement.alt = `Fire Perform ${i + 1}`;
