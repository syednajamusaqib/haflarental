document.addEventListener('DOMContentLoaded', function () {
  ...
  const images = [
    'service5_images/1.JPG',
    'service5_images/2.JPG',
    'service5_images/3.jpg',
    'service5_images/4.jpg',
    'service5_images/5.jpg',
  ];

  let currentImageCount = 5; // Initial images are already loaded
  ...
  function loadImages(count) {
    for (
      ...
      imgElement.alt = `Face Painter ${i + 1}`;
