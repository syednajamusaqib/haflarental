document.addEventListener("DOMContentLoaded", function () {
  ...
  const images = [
    'service9_images/1.jpg',
    'service9_images/2.jpg',
    'service9_images/3.jpg',
    'service9_images/4.jpg',
    'service9_images/5.jpg',
    'service9_images/6.jpg',
  ];

  let currentImageCount = 6;  // Initial images are already loaded
