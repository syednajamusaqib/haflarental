document.addEventListener("DOMContentLoaded", function () {
  ...
  const images = [
    "service3_images/1.jpg", "service3_images/2.jpg", 
    "service3_images/3.jpg", "service3_images/4.jpg", 
    "service3_images/5.jpg", "service3_images/6.jpg", 
    "service3_images/7.jpg", "service3_images/8.jpg",
    "service3_images/9.jpg",
  ];
  ...
  function loadImages(count) {
    for (let i = currentImageCount; i < currentImageCount + count && i < images.length; i++) {
      ...
      imgElement.alt = `Party Packages ${i + 1}`;
