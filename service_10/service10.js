document.addEventListener("DOMContentLoaded", function () {
  ...
  const images = [
    'service10_images/1.jpg',
    'service10_images/2.jpg',
    'service10_images/3.jpg',
    'service10_images/4.jpg',
    'service10_images/5.jpg',
    'service10_images/6.jpg',
    'service10_images/7.jpg',
    'service10_images/8.jpg',
    'service10_images/9.jpg',
  
  ];

  let currentImageCount = 9;  // Initial images are already loaded
  ...
  function loadImages(count) {
    for (let i = currentImageCount; i < currentImageCount + count && i < images.length; i++) {
      ...
      imgElement.alt = `Bubble Show ${i + 1}`;
